...
export function generateCertificatePDF(order) {
  ...
  doc.setFontSize(14);
  doc.text('✦', centerX, 55, { align: 'center' });

  // Ornamental divider under title
  doc.setDrawColor(...colors.goldLight);
  doc.setLineWidth(0.3);
  doc.line(centerX - 40, 60, centerX - 10, 60);
  doc.line(centerX + 10, 60, centerX + 40, 60);
  doc.text('◆', centerX, 61, { align: 'center' });
  ...
  doc.setDrawColor(...colors.goldLight);
  doc.setLineWidth(0.3);
  doc.line(centerX - 35, 125, centerX - 5, 125);
  doc.text('◆', centerX, 126, { align: 'center' });
  doc.line(centerX + 5, 125, centerX + 35, 125);
  ...
  doc.setDrawColor(...colors.goldLight);
  doc.setLineWidth(0.3);
  doc.line(40, 258, 85, 258);
  doc.text('✦', centerX, 259, { align: 'center' });
  doc.line(125, 258, 170, 258);
